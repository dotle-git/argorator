...
class ArgumentAnnotation(BaseModel):
    ...
    type: Literal["str", "int", "float", "bool", "choice", "file"] = Field(
        default="str", description="The argument type"
    )
    ...
    alias: Optional[str] = Field(
        default=None, description="Short alias for the argument (e.g., '-v')"
    )
    choices: Optional[List[str]] = Field(
        default=None, description="Valid choices for choice type arguments"
    )
...
class ScriptMetadata(BaseModel):
    ...
    description: Optional[str] = Field(
        default=None, description="Script description from # Description: comment"
    )
...
class ScriptInterface(BaseModel):
    ...
    description: Optional[str] = Field(
        default=None, description="Script description from metadata"
    )
    arguments: List[ArgumentInfo] = Field(
        default_factory=list, description="List of named arguments"
    )
    positionals: List[PositionalInfo] = Field(
